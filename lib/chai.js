...
module.exports = function (chai, util) {
  ...
  assert.isOk = function (val, msg) {
    new Assertion(val, msg).toBeTruthy();
  };
  ...
  assert.isNotOk = function (val, msg) {
    new Assertion(val, msg).toBeFalsy();
  };
  ...
  assert.isNotNaN = function (val, msg) {
    new Assertion(val, msg).not.toBeNaN();
  };
...
module.exports = function (chai, util) {
  ...
  function loadShould () {
    ...
    should.toBeDefined() = function (val, msg) {
      new Assertion(val, msg).toBeDefined();
    }
    ...
    should.toBeFalsy() = function (val, msg) {
      new Assertion(val, msg).toBeFalsy();
    }
